...
$(document).on('nifty.ready', function() {
    ...
    var opts1 = {
        ...
        colorStart: '#fff', // Colors
        colorStop: '#fff', // just experiment with them
        strokeColor: '#448E19', // to see which ones work best for you
        generateGradient: true
    };


    var target1 = document.getElementById('demo-gauge1'); // your canvas element
    var gauge1 = new Gauge(target1).setOptions(opts1); // create sexy gauge!
    gauge1.maxValue = 1200; // set max gauge value
    gauge1.animationSpeed = 32; // set animation speed (32 is default value)
    gauge1.set(991); // set actual value
    gauge1.setTextField(document.getElementById("demo-gauge-text1"));
